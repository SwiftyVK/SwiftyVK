extension _VKAPI {
  ...
  public struct Polls {
    ...
    public static func addVote(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func deleteVote(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getVoters(_ parameters: [VK.Arg : String] = [:]) -> Request {
