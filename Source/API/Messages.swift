extension _VKAPI {
  ...
  public struct Messages {
    ...
    public static func getDialogs(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getHistory(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func send(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func deleteDialog(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func markAsRead(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func markAsImportant(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getLongPollServer(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getLongPollHistory(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getChat(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func createChat(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func editChat(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getChatUsers(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func setActivity(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func searchDialogs(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func addChatUser(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func removeChatUser(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getLastActivity(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func setChatPhoto(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func deleteChatPhoto(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getHistoryAttachments(_ parameters: [VK.Arg : String] = [:]) -> Request {
