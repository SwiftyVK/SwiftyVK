extension _VKAPI {
  ...
  public struct Users {
    ...
    public static func isAppUser(parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getSubscriptions(parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getFollowers(parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getNearby(parameters: [VK.Arg : String] = [:]) -> Request {
