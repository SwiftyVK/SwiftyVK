extension _VKAPI {
  ...
  public struct Groups {
    ...
    public static func isMember(parameters: [VK.Arg : String]?) -> Request {
    ...
    public static func getMembers(parameters: [VK.Arg : String]?) -> Request {
    ...
    public static func join(parameters: [VK.Arg : String]?) -> Request {
    ...
    public static func leave(parameters: [VK.Arg : String]?) -> Request {
    ...
    public static func getInvites(parameters: [VK.Arg : String]?) -> Request {
    ...
    public static func getInvitedUsers(parameters: [VK.Arg : String]?) -> Request {
    ...
    public static func editPlace(parameters: [VK.Arg : String]?) -> Request {
    ...
    public static func getSettings(parameters: [VK.Arg : String]?) -> Request {
    ...
    public static func editManager(parameters: [VK.Arg : String]?) -> Request {
    ...
    public static func invite(parameters: [VK.Arg : String]?) -> Request {
    ...
    public static func deleteLink(parameters: [VK.Arg : String]?) -> Request {
    ...
    public static func editLink(parameters: [VK.Arg : String]?) -> Request {
    ...
    public static func reorderLink(parameters: [VK.Arg : String]?) -> Request {
