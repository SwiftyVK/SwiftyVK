extension _VKAPI {
  ...
  public struct Places {
    ...
    public static func checkin(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getCheckins(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getTypes(_ parameters: [VK.Arg : String] = [:]) -> Request {
