extension _VKAPI {
  ...
  public struct Utils {
    ...
    public static func checkLink(parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func resolveScreenName(parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getServerTime(parameters: [VK.Arg : String] = [:]) -> Request {
