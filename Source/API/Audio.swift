extension _VKAPI {
  ...
  public struct Audio {
    ...
    public static func getLyrics(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func reorder(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func setBroadcast(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getBroadcastList(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getRecommendations(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getPopular(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getCount(_ parameters: [VK.Arg : String] = [:]) -> Request {
