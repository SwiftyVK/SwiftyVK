extension _VKAPI {
  ...
  public struct Database {
    ...
    public static func getCountries(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getRegions(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getStreetsById(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getCountriesById(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getCities(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getCitiesById(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getUniversities(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getSchools(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getSchoolClasses(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getFaculties(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getChairs(_ parameters: [VK.Arg : String] = [:]) -> Request {
