extension _VKAPI {
  ...
  public struct Pages {
    ...
    public static func saveAccess(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getTitles(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getVersion(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func parseWiki(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func clearCache(_ parameters: [VK.Arg : String] = [:]) -> Request {
