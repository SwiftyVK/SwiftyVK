extension _VKAPI {
  ...
  public struct Friends {
    ...
    public static func get(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "friends.get", parameters: parameters)
    }



    ///Returns a list of user IDs of a user's friends who are online. More - https://vk.com/dev/friends.getOnline
    public static func getOnline(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "friends.getOnline", parameters: parameters)
    }



    ///Returns a list of user IDs of the mutual friends of two users. More - https://vk.com/dev/friends.getMutual
    public static func getMutual(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "friends.getMutual", parameters: parameters)
    }



    ///Returns a list of user IDs of the current user's recently added friends. More - https://vk.com/dev/friends.getRecent
    public static func getRecent(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "friends.getRecent", parameters: parameters)
    }
    ...
    public static func getRequests(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "friends.getRequests", parameters: parameters)
    }
    ...
    public static func add(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "friends.add", parameters: parameters)
    }
    ...
    public static func edit(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "friends.edit", parameters: parameters)
    }
    ...
    public static func delete(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "friends.delete", parameters: parameters)
    }
    ...
    public static func getLists(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "friends.getLists", parameters: parameters)
    }



    ///Creates a new friend list for the current user. More - https://vk.com/dev/friends.addList
    public static func addList(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "friends.addList", parameters: parameters)
    }



    ///Edits a friend list of the current user. More - https://vk.com/dev/friends.editList
    public static func editList(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "friends.editList", parameters: parameters)
    }
    ...
    public static func deleteList(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "friends.deleteListr", parameters: parameters)
    }
    ...
    public static func getAppUsers(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "friends.getAppUsers", parameters: parameters)
    }



    ///Returns a list of the current user's friends whose phone numbers, validated or specified in a profile, are in a given list. 
    ///More - https://vk.com/dev/friends.getByPhones
    public static func getByPhones(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "friends.getByPhones", parameters: parameters)
    }



    ///Marks all incoming friend requests as viewed. More - https://vk.com/dev/friends.deleteAllRequests
    public static func deleteAllRequests(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "friends.deleteAllRequests", parameters: parameters)
    }



    ///Returns a list of profiles of users whom the current user may know. More - https://vk.com/dev/friends.getSuggestions
    public static func getSuggestions(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "friends.getSuggestions", parameters: parameters)
    }



    ///Checks the current user's friendship status with other specified users. More - https://vk.com/dev/friends.areFriends
    public static func areFriends(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "friends.areFriends", parameters: parameters)
    }



    ///Return list of avialable for call users. More - https://vk.com/dev/friends.getAvailableForCall
    public static func getAvailableForCall(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "friends.getAvailableForCall", parameters: parameters)
    }
    ...
    public static func search(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "friends.search", parameters: parameters)
    }
  }
}
