extension _VKAPI {
  ...
  public struct Account {
    ...
    public static func getCounters(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func setNameInMenu(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func setOnline(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func setOffline(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func lookupContacts(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func registerDevice(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func unregisterDevice(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func setSilenceMode(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getPushSettings(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func setPushSettings(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getAppPermissions(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getActiveOffers(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getInfo(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func setInfo(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func changePassword(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getProfileInfo(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func saveProfileInfo(_ parameters: [VK.Arg : String] = [:]) -> Request {
