extension _VKAPI {
  ...
  public struct Account {
    ...
    ///that is shown to the user in the left menu. More - https://vk.com/dev/account.setNameInMenu
    ...
    ///Allows to search the VK users using phone nubmers,
    ///e-mail addresses and user IDs on other services. More - https://vk.com/dev/account.lookupContacts
