extension _VKAPI {
  ...
  public struct Board {
    ...
    public static func getTopics(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func addTopic(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func deleteTopic(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func editTopic(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func openTopic(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func closeTopic(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func fixTopic(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func unfixTopic(_ parameters: [VK.Arg : String] = [:]) -> Request {
