extension _VKAPI {
  ...
  public struct NewsFeed {
    ...
    public static func getRecommended(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getMentions(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func addBan(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func deleteBan(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func ignoreItem(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func unignoreItem(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func saveList(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func unsubscribe(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getSuggestedSources(_ parameters: [VK.Arg : String] = [:]) -> Request {
