extension _VKAPI {
  ...
  public struct Groups {
    ...
    public static func isMember(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.isMember", parameters: parameters)
    }
    ...
    public static func getById(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.getById", parameters: parameters)
    }
    ...
    public static func get(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.get", parameters: parameters)
    }



    ///Returns a list of community members. More - https://vk.com/dev/groups.getMembers
    public static func getMembers(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.getMembers", parameters: parameters)
    }
    ...
    public static func join(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.join", parameters: parameters)
    }



    ///With this method you can leave a group, public page, or event. More - https://vk.com/dev/groups.leave
    public static func leave(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.leave", parameters: parameters)
    }
    ...
    public static func search(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.search", parameters: parameters)
    }



    ///Returns a list of invitations to join communities and events. More - https://vk.com/dev/groups.getInvites
    public static func getInvites(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.getInvites", parameters: parameters)
    }
    ...
    public static func banUser(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.banUser", parameters: parameters)
    }
    ...
    public static func unbanUser(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.unbanUser", parameters: parameters)
    }
    ...
    public static func getBanned(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.getBanned", parameters: parameters)
    }
    ...
    public static func create(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.create", parameters: parameters)
    }
    ...
    public static func edit(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.edit", parameters: parameters)
    }



    ///Edit community places. More - https://vk.com/dev/groups.editPlace
    public static func editPlace(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.editPlace", parameters: parameters)
    }



    ///Returns data necessary to display the data editing community. More - https://vk.com/dev/groups.getSettings
    public static func getSettings(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.getSettings", parameters: parameters)
    }



    ///Returns a list requests for entry into the community. More - https://vk.com/dev/groups.getRequests
    public static func getRequests(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.getRequests", parameters: parameters)
    }
    ...
    public static func editManager(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.editManager", parameters: parameters)
    }



    ///Allows invite users to community. More - https://vk.com/dev/groups.invite
    public static func invite(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.invite", parameters: parameters)
    }
    ...
    public static func addLink(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.addLink", parameters: parameters)
    }



    ///Allows remove links to community. More - https://vk.com/dev/groups.deleteLink
    public static func deleteLink(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.deleteLink", parameters: parameters)
    }



    ///Allows edit links to community. More - https://vk.com/dev/groups.editLink
    public static func editLink(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.editLink", parameters: parameters)
    }



    ///Allows you to change the location of the reference list. More - https://vk.com/dev/groups.reorderLink
    public static func reorderLink(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.reorderLink", parameters: parameters)
    }
    ...
    public static func removeUser(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.removeUser", parameters: parameters)
    }



    ///Allows you to approve a request from the user to the community. More - https://vk.com/dev/groups.approveRequest
    public static func approveRequest(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.approveRequest", parameters: parameters)
    }
    ...
    public static func getCatalog(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.getCatalog", parameters: parameters)
    }



    ///Returns list of categories of selected group. More - https://vk.com/dev/groups.getCatalogInfo
    public static func getCatalogInfo(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "groups.getCatalogInfo", parameters: parameters)
    }
  }
}
