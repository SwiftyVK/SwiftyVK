extension _VKAPI {
  ...
  public struct Fave {
    ...
    public static func getUsers(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getPhotos(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getPosts(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getVideos(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getLinks(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func addUser(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func addGroup(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func removeGroup(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func removeLink(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getMarketItems(_ parameters: [VK.Arg : String] = [:]) -> Request {
