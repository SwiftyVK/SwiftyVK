extension _VKAPI {
  ...
  public struct Wall {
    ...
    public static func post(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func repost(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getReposts(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func pin(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func unpin(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func reportPost(_ parameters: [VK.Arg : String] = [:]) -> Request {
