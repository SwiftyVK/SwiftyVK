extension _VKAPI {
  ...
  public struct Photos {
    ...
    public static func createAlbum(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getAlbumsCount(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getUploadServer(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getOwnerPhotoUploadServer(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getChatUploadServer(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func saveOwnerPhoto(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func saveWallPhoto(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getWallUploadServer(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getMessagesUploadServer(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func saveMessagesPhoto(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func copy(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func move(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func makeCover(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func reorderPhotos(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getAll(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getUserPhotos(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func confirmTag(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getAllComments(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getMarketAlbumUploadServer(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func saveMarketPhoto(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func saveMarketAlbumPhoto(_ parameters: [VK.Arg : String] = [:]) -> Request {
    ...
    public static func getMarketUploadServer(_ parameters: [VK.Arg : String] = [:]) -> Request {
