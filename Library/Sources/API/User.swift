extension _VKAPI {
  ...
  public struct Users {
    ...
    public static func get(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "users.get", parameters: parameters)
    }
    ...
    public static func search(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "users.search", parameters: parameters)
    }

    ///Returns information whether a user installed the application. More - https://vk.com/dev/users.isAppUser
    public static func isAppUser(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "users.isAppUser", parameters: parameters)
    }

    ///Returns a list of IDs of users and communities followed by the user. More - https://vk.com/dev/users.getSubscriptions
    public static func getSubscriptions(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "users.getSubscriptions", parameters: parameters)
    }

    ///Returns a list of IDs of followers of the user in question, sorted by date added, most recent first. 
    ///More - https://vk.com/dev/users.getFollowers
    public static func getFollowers(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "users.getFollowers", parameters: parameters)
    }
    ...
    public static func report(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "users.report", parameters: parameters)
    }
    ...
    public static func getNearby(_ parameters: [VK.Arg : String] = [:]) -> RequestConfig {
      return RequestConfig(method: "users.getNearby", parameters: parameters)
    }
  }
}
