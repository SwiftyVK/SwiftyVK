// Generated by Apple Swift version 3.0 (swiftlang-800.0.41.2 clang-800.0.36)
...
@interface NSNumber (SWIFT_EXTENSION(SwiftyVK))
@end

@class NSNotificationCenter;

SWIFT_CLASS("_TtC8SwiftyVK12Reachability")
...
+ (Reachability * _Nullable)reachabilityForInternetConnectionAndReturnError:(NSError * _Nullable * _Nullable)error;
+ (Reachability * _Nullable)reachabilityForLocalWiFiAndReturnError:(NSError * _Nullable * _Nullable)error;
