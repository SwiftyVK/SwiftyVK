// Generated by Apple Swift version 2.2 (swiftlang-703.0.6.5 clang-703.0.21)
...
+ (Reachability * _Nonnull)reachabilityForInternetConnection;
+ (Reachability * _Nonnull)reachabilityForLocalWiFi;
- (BOOL)startNotifier;
- (void)stopNotifier;
- (BOOL)isReachable;
